            ...
            <form method="POST" action="{{ gp247_route_front('customer.post_change_infomation') }}">
                ...
                <div class="form-group row {{ $errors->has('first_name') ? ' has-error' : '' }}">
                    <label for="first_name"
                        class="col-md-4 col-form-label text-md-right">{{ gp247_language_render('customer.first_name') }}</label>
                ...
                <div class="form-group row {{ $errors->has('last_name') ? ' has-error' : '' }}">
                    <label for="last_name"
                        class="col-md-4 col-form-label text-md-right">{{ gp247_language_render('customer.last_name') }}</label>
                ...
                <div class="form-group row {{ $errors->has('first_name') ? ' has-error' : '' }}">
                    <label for="first_name"
                        class="col-md-4 col-form-label text-md-right">{{ gp247_language_render('customer.name') }}</label>
                ...
                <div class="form-group row {{ $errors->has('first_name_kana') ? ' has-error' : '' }}">
                    <label for="first_name_kana"
                        class="col-md-4 col-form-label text-md-right">{{ gp247_language_render('customer.first_name_kana') }}</label>
                ...
                <div class="form-group row {{ $errors->has('last_name_kana') ? ' has-error' : '' }}">
                    <label for="last_name_kana"
                        class="col-md-4 col-form-label text-md-right">{{ gp247_language_render('customer.last_name_kana') }}</label>
                ...
                <div class="form-group row {{ $errors->has('phone') ? ' has-error' : '' }}">
                    <label for="phone"
                        class="col-md-4 col-form-label text-md-right">{{ gp247_language_render('customer.phone') }}</label>
                ...
                <div class="form-group row {{ $errors->has('postcode') ? ' has-error' : '' }}">
                    <label for="postcode"
                        class="col-md-4 col-form-label text-md-right">{{ gp247_language_render('customer.postcode') }}</label>
                ...
                <div class="form-group row {{ $errors->has('email') ? ' has-error' : '' }}">
                    <label for="email"
                        class="col-md-4 col-form-label text-md-right">{{ gp247_language_render('customer.email') }}</label>
                ...
                <div class="form-group row {{ $errors->has('address1') ? ' has-error' : '' }}">
                    <label for="address1"
                        class="col-md-4 col-form-label text-md-right">{{ gp247_language_render('customer.address1') }}</label>
                ...
                <div class="form-group row {{ $errors->has('address2') ? ' has-error' : '' }}">
                    <label for="address2"
                        class="col-md-4 col-form-label text-md-right">{{ gp247_language_render('customer.address2') }}</label>
                    <div class="col-md-6">
                ...
                <div class="form-group row {{ $errors->has('address3') ? ' has-error' : '' }}">
                    <label for="address3"
                        class="col-md-4 col-form-label text-md-right">{{ gp247_language_render('customer.address3') }}</label>
                    <div class="col-md-6">
                ...
                <div class="form-group row {{ $errors->has('country') ? ' has-error' : '' }}">
                    <label for="country"
                        class="col-md-4 col-form-label text-md-right">{{ gp247_language_render('customer.country') }}</label>
                    <div class="col-md-6">
                ...
                <div class="form-group row {{ $errors->has('sex') ? ' has-error' : '' }}">
                    <label for="sex"
                        class="col-md-4 col-form-label text-md-right">{{ gp247_language_render('customer.sex') }}</label>
                ...
                <div class="form-group row {{ $errors->has('birthday') ? ' has-error' : '' }}">
                    <label for="birthday"
                        class="col-md-4 col-form-label text-md-right">{{ gp247_language_render('customer.birthday') }}</label>
