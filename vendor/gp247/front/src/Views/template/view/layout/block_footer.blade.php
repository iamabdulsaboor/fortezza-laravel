            ...
            <div class="row row-40 row-md-50 justify-content-xl-between">
              <div class="col-sm-6 col-lg-4 col-xl-3 wow fadeInRight">
                <a href="{{ gp247_route_front('front.home') }}">
                    <img class="logo-footer" src="{{  gp247_file(gp247_store_info(key:'logo', default:null, storeId:($storeId ?? null))) }}" alt="{{ gp247_store_info(key:'title', default:null, storeId:($storeId ?? null)) }}">
                </a>
                <p>{{ gp247_store_info(key:'title', default:null, storeId:($storeId ?? null)) }}</p>
                <p> {!! gp247_store_info(key:'time_active', default:null, storeId:($storeId ?? null))  !!}</p>
                ...
                <ul class="contacts-creative">
                  <li>
                    <div class="unit unit-spacing-sm flex-column flex-md-row">
                      ...
                      <div class="unit-body"><a href="#">{{ gp247_language_render('store.address') }}: {{ gp247_store_info(key:'address', default:null, storeId:($storeId ?? null)) }}</a></div>
                    </div>
                  </li>
                  <li>
                    <div class="unit unit-spacing-sm flex-column flex-md-row">
                      <div class="unit-left"><span class="icon mdi mdi-phone"></span></div>
                      <div class="unit-body"><a href="tel:#">{{ gp247_language_render('store.hotline') }}: {{ gp247_store_info(key:'long_phone', default:null, storeId:($storeId ?? null)) }}</a></div>
                    </div>
                  </li>
                  <li>
                    <div class="unit unit-spacing-sm flex-column flex-md-row">
                      <div class="unit-left"><span class="icon mdi mdi-email-outline"></span></div>
                      <div class="unit-body"><a href="mailto:#{{ gp247_store_info(key:'email', default:null, storeId:($storeId ?? null)) }}">{{ gp247_language_render('store.email') }}: {{ gp247_store_info(key:'email', default:null, storeId:($storeId ?? null)) }}</a></div>
                    </div>
                  </li>
                  <li>
          ...
          <div class="container">
            <div class="row row-10 align-items-center justify-content-sm-between">
              <div class="col-md-auto">
                <p class="rights"><span>&copy;&nbsp;</span><span class="copyright-year"></span><span>&nbsp;</span><span>{{ gp247_store_info(key:'title', default:null, storeId:($storeId ?? null)) }}</span><span>.&nbsp; All rights reserved</span></p>
              </div>
